package Snapshots::Database;
use Snapshots::Analyzer ;
use Snapshots::Cfg ;
use Snapshots::Functions qw(ratio hitrate commafy sum_of_diff tmdiff delta orderby hashdiff resolve_formula_fields inputcheck);
use strict;
...
sub report
{
	...
	my $analyzer = new Snapshots::Analyzer ( $interval ) ;
