...
use Sys::Hostname;
use Fcntl 'SEEK_SET' ;
use Snapshots::DeepHash ;
use Snapshots::Functions qw(ratio hitrate commafy sum_of_diff tmdiff delta orderby hashdiff );
...
sub new
{
	...
	case "jsmacpro15touch"   = { $tmpdir = "/Users/kr050496/bin/temp" }
